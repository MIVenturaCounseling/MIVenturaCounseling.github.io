...
function submit_email()
{
    ...
    else
    {
        ...
        {
                document.getElementById("error").value = "First name can not be more then 50 characters";
        }
        else
        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            if(message.length == 0)
                            {
                                    document.getElementById("error").value = "Please enter a message";
                            }
                            else
                            {
...
function checkScreen()
{
    ...
    var limit_of_screen = 900;
                        ...
                        if((screen_width > limit_of_screen) && (browser_width > limit_of_screen))
                        {
                            ...
                            document.getElementById("price_title_group").style.fontSize = "30px";
                            document.getElementById("price_block_group_cost").style.fontSize = "19px";
